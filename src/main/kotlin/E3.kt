...
fun main(){
    var s1=Student("Kishan","Patel",21,20012011102,"CE","D","AB12")
    var s2=Student("Anuj","Patel",20,20012011077,"CE","D","AB12")
    var s3=Student("Dhruv","Patel",21,20012011086,"CE","D","AB12")
    var s4=Student("Manav","Patel",21,20012011109,"CE","D","AB12")
    var s5=Student("Dharmik","Patel",20,20012011084,"CE","D","AB12")
}